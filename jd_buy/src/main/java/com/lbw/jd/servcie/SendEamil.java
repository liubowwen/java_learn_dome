...
public class SendEamil {
    public static void eamil(String message,String title) throws MessagingException, GeneralSecurityException {
        //创建一个配置文件并保存
        ...
        //邮件接收人
        mimeMessage.setRecipient(Message.RecipientType.TO,new InternetAddress("854226741@qq.com"));
